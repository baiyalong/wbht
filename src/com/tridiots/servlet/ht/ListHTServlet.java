...
public class ListHTServlet extends HttpServlet
{
	private static final long serialVersionUID = -2486237487130999485L;
			...
			throws ServletException, IOException
	{
		...
		try {
			...
			out.println(JSONObject.fromObject(htDao.listHtKu(iStart, iLimit, gjc, htlx, yaodian, gslx,companyName,usertype,alsousuo)));
