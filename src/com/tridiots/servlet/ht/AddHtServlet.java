...
import com.tridiots.utils.StringUtil;

public class AddHtServlet extends HttpServlet
{
	private static final long serialVersionUID = 6267664541875614861L;
			...
			throws ServletException, IOException
	{
		...
		String domainKey = StringUtil.createDomainKey();//ht主体主键
		...
		ht.setNote(bz);
		ht.setGonghao(zh);
		ht.setCompanyName(companyName);
		ht.setUsertype(usertype);
		/////////////////////////////////
		...
		result.put("isAddHtSuccess", this.htDao.addHt(ht, taxs));
