...
public class IsRepeateAdminAcount extends HttpServlet
{
	private static final long serialVersionUID = 6216513466672534587L;
			...
			throws ServletException, IOException
	{
		...
		result.put("isRepeateAdminAcount", this.superAdminDao.isRepeatAdminAcount(adminAcount));
