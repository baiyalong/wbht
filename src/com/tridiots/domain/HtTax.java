...
public class HtTax
{
	...
	private String al;
	private String fg;
	private String ht_taxtype;//税种
	private String ht_id;//用于找到对应的合同
	...
	public String getHt_taxtype()
	{
		return ht_taxtype;
	}
	public void setHt_taxtype(String ht_taxtype)
	{
		this.ht_taxtype = ht_taxtype;
	}
