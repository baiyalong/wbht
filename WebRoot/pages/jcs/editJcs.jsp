		...
		<div style="margin-top:-15px;">
			<h3 class="text-center" style="color:blue;font-family: 微软雅黑">更新数据</h3>
								      ...
								      <div class="panel-body">
								      	<!-- 主体开始 -->
								      		<dl class="dl-horizontal">
								      		  ...
								      		  <dd>
											  <dt>标题</dt>
											  <dd><textarea class="form-control bt">${htDetail.title}</textarea></dd>
											  <dt>要点</dt>
				      ...
				      <div class="text-center">
				      	<button type="button" id="confirmEditJcs" class="btn btn-default btn-primary btn-lg">确定</button>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#confirmEditJcs').click(function(){
				...
				eDitJcs(id,yiji,erji,bt,yaodian,gslx,gjc,bz,al,
