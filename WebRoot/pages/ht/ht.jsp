  ...
  <body>
		...
		<!-- 导航条界面结束 -->
      	...
      	<div class="row">
	      		  	...
	      		  	<div class="erjijiediandiv"><font class="erjijiedian">二级</font></div>
				  		<%
	      		  			for(int i=0;i<nodeLen;i++)
	      		  			{
	      		  				...
	      		  				{
	      		  		 %>
					      		  	<%-- <select class="erji_cd_<%=i+1 %> erji_cd form-control" style="display: inline;">  --%>
			...
			<div class="addAndSearch col-md-3 col-md-offset-1 col-lg-3 col-lg-offset-1">
	        	<!-- <a id="addHt" data-toggle="modal" href="#htModal" 
	        	class="btn btn-primary"><i class='glyphicon glyphicon-plus'></i>&nbsp;增加</a> -->
	        	<a id="addHt" href="addHt.jsp" 
	        	class="btn btn-primary"><i class='glyphicon glyphicon-plus'></i>&nbsp;增加</a>
      	...
      	<!-- <div class="row">
                <div><button id="addHt" data-toggle="modal" data-target="#htModal" class="btn btn-primary  btn-lg col-xs-5 col-sm-5 col-md-5 col-lg-5"><span class='glyphicon glyphicon-pencil'></span>&nbsp;&nbsp;增加合同控税数据</button></div>
                <div><button id="sousuo" data-toggle="modal" data-target="#sousuoModal" class="btn btn-primary btn-lg col-xs-5 col-xs-offset-2 col-sm-5 col-sm-offset-2 col-md-5 col-md-offset-2 col-lg-5 col-lg-offset-2"><span class='glyphicon glyphicon-search'></span>&nbsp;&nbsp;搜索合同控税数据</button></div>
        </div> -->
        <div class="row" style="margin-top: 10px;">
            	<div class="allHt_table_body" >
            			<!-- Ajax填充 -->
            	</div>
		...
		<footer style="text-align: center;margin-top: 20px;">
     	...
     	<!-- 版权说明结束 -->
			...
			<!-- 查看全文modal结束 -->
     		...
     		<!-- 搜索合同modal开始 -->
			<div class="modal fade" id="sousuoModal" tabindex="-1" role="dialog" aria-labelledby="htModalLabel" aria-hidden="true"  data-backdrop="static">
				  <div class="modal-dialog modal-lg">
					    <div class="modal-content">
						      <div class="modal-header">
							        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
			...
			<!-- 搜索合同modal结束 -->
     		...
     		<!-- 增加合同modal开始 -->
			<div class="modal fade" id="htModal" tabindex="-1" role="dialog" aria-labelledby="htModalLabel" aria-hidden="true"  data-backdrop="static">
				  <div class="modal-dialog modal-lg">
					    <div class="modal-content">
						      <div class="modal-header">
							        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
							        <h4 class="modal-title" id="htModalLabel">增加合同控税数据</h4>
						      </div>
										      ...
										      <div class="panel-body"> 
										      	<!-- 主体开始 --> 
													  ...
													  <dt>要点</dt> 
									  				  ...
									  				  <dt>案例</dt> 
													  <dd>
													  <!-- <div class="popover"><div class="arrow"><h3 class="popover-title"></h3><div class="popover-content">123123</div></div></div> -->
													  <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" title="Popover title" data-content="sdasdasdasdasd">Click to toggle popover</button>
													  </dd> 
														<!--<dd><textarea class="form-control al"></textarea></dd>  -->
													  <p class="help-block text-center">一定要注意：案例标题之间以英文分号&ldquo;;&rdquo;隔开</p> 
													  <dt>公司类型</dt> 
													  <dd> 
						      ...
						      <div class="modal-footer">
						      	<button type="button" id="confirmAddHt" class="btn btn-default btn-primary" data-dismiss="modal">确定</button>
	...
	<script type="text/javascript">
		$(function(){
						...
						///////////////////权限问题结束/////////////////////
						loadHt(0,1,true,null,null,null,null,zh,companyName,usertype,servletpath);
