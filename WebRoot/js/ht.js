 ...
 * 更新
 */
function eDitHt(id,yiji,erji,htlx,yaodian,gslx,gjc,bz,al,
		  ...
		  yh_chd1,yh_tj1,yh_chd2,yh_tj2,yh_chd3,yh_tj3,yh_al,yh_wq,yh_fx,yh_fg)
{
    $.ajax({
        ...
        success: function( json ) {
        	if(json.isEditHtSuccess)
    		{
        		alert("更新成功！！！");
        		window.location.href="pages/ht/ht.jsp";
    		}
        	else{
        		alert("更新失败！！！");
        	}
 ...
 * 增加合同控税数据
 */
function addHt(yiji,erji,htlx,yaodian,gslx,gjc,bz,al,zh,companyName,usertype,
		  yy_chd1,yy_tj1,yy_chd2,yy_tj2,yy_chd3,yy_tj3,yy_al,yy_wq,yy_fx,yy_fg,
		  qy_chd1,qy_tj1,qy_chd2,qy_tj2,qy_chd3,qy_tj3,qy_al,qy_wq,qy_fx,qy_fg,
		  tdzz_chd1,tdzz_tj1,tdzz_chd2,tdzz_tj2,tdzz_chd3,tdzz_tj3,tdzz_al,tdzz_wq,tdzz_fx,tdzz_fg,
		  zz_chd1,zz_tj1,zz_chd2,zz_tj2,zz_chd3,zz_tj3,zz_al,zz_wq,zz_fx,zz_fg,
...
function loadHt(start, limit, init, gjc, htlx, yaodian, gslx,zh,companyName,usertype,servletpath,alsousuo) {
    
	$(".allHt_table_body").empty();
    $(".allHt_table_body").html("<p style='text-align: center;width:100%;'><img src='../../imgs/load.jpg'/></p>");
...
/////////////1///////
             	...
             	var $td_id_temp = $("<td class='delButton'>"+content[i].domainKey+"</td>");
             	...
             	if(((usertype=="admin")&&(content[i].companyName==companyName)&&(content[i].gonghao==zh))||((usertype=="superadmin")&&(content[i].companyName==companyName)))
         		{
	             	...
	             	var $td_del_temp = $("<td colspan='2' class='delButton'>" +
	             			...
	             			"href='../../FindHtAndTaxByIdServlet?id="+content[i].domainKey+"'>" +
	             				"<span class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;修改数据" +
	             			"</a>"+
	             			"<a data-toggle='modal' data-target='#confirmModalxxht"+i+"'" +
	             			" class='btn btn-danger delModalButtonJs col-xs-5 col-xs-offset-2 col-sm-5 col-sm-offset-2 col-md-5 col-md-offset-2 col-lg-5 col-lg-offset-2' rel='../../DeleteHtServlet?id="+content[i].domainKey+"'>" +
             	...
             	$(".allHt_table_body").append($table_temp);
             	
             	////////////////////////////////
             	//////////////////动态生成模态框开始////////////////////////
             	var $modal = $("<div id='confirmModalxxht"+i+"' data-backdrop='static' class='modal fade' id='delModal' tabindex='-1' role='dialog' aria-labelledby='delModalLabel' aria-hidden='true'></div>");
             	...
             	/*//////////////////动态生成修改法规模态框开始////////////////////////
             	var $modal = $("<div id='editFgModal"+i+"' data-backdrop='static' class='modal fade' id='delModal' tabindex='-1' role='dialog' aria-labelledby='delModalLabel' aria-hidden='true'></div>");
             	var $modal1 = $("<div class='modal-dialog modal-lg'></div>");
             	var $modal2 = $("<div class='modal-content'></div>");
             	
             	var $modal30 = $("<div class='modal-header'><button type='button' class='close' data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button><h4 class='modal-title' id='delModalLabel'>确定删除</h4></div>");
             	var $modal31 = $("<div class='modal-body'>" +
             			"<dl class='dl-horizontal'>dt>法规文号</dt><dd><input type="text" class="form-control fgwhDetail" value="" name="fgwh"></dd>
									  <dt>法规条文</dt>
             ...
             // 绑定弹窗
                ...
                if(init){
                    ...
                    onPageClicked: function(e,originalEvent,type,page){
                    	loadHt(1*(page-1),1,false, gjc, htlx, yaodian, gslx,zh,companyName,usertype,servletpath,alsousuo);
                    }
                };
...
///////////////////////////////////////////////////////////////////////
function loadHtByJilian(start, limit, init, yijicd, erji,zh,companyName,usertype,servletpath) {
    
	$(".allHt_table_body").empty();
    $(".allHt_table_body").html("<p style='text-align: center;width:100%;'><img src='../../imgs/load.jpg'/></p>");
    
    $.ajax({
            url: "../../ListHTByJilianServlet",
            data: {
            	start: start,
                limit: limit,
                yijicd: yijicd,
...
///////////1/////////
             	...
             	if(((usertype=="admin")&&(content[i].companyName==companyName)&&(content[i].gonghao==zh))||((usertype=="superadmin")&&(content[i].companyName==companyName)))
         		{
	             	...
	             	var $td_del_temp = $("<td colspan='2' class='delButton'>" +
	             			...
	             			"href='../../FindHtAndTaxByIdServlet?id="+content[i].domainKey+"'>" +
	             				"<span class='glyphicon glyphicon-edit'></span>&nbsp;&nbsp;修改数据" +
	             			"</a>"+
	             			"<a data-toggle='modal' data-target='#confirmModalxxhtjl"+i+"'" +
	             			" class='btn btn-danger delModalButtonJs col-xs-5 col-xs-offset-2 col-sm-5 col-sm-offset-2 col-md-5 col-md-offset-2 col-lg-5 col-lg-offset-2' rel='../../DeleteHtServlet?id="+content[i].domainKey+"'>" +
	             				"<span class='glyphicon glyphicon-trash'></span>&nbsp;&nbsp;删除数据" +
	             			"</a></td>");
             	...
             	////////////////////////////////
//////////////////动态生成模态框开始////////////////////////
             	var $modal = $("<div id='confirmModalxxhtjl"+i+"' data-backdrop='static' class='modal fade' id='delModal' tabindex='-1' role='dialog' aria-labelledby='delModalLabel' aria-hidden='true'></div>");
             	var $modal1 = $("<div class='modal-dialog modal-lg'></div>");
             	var $modal2 = $("<div class='modal-content'></div>");
             ...
             // 绑定弹窗
                           ...
                           $.ajax({
                             ...
                             success: function( json ) {
                             	if(json.isDeleteHtSuccess)
                         		{
                             		alert("删除成功！！！");
                             		$('.modal-backdrop').remove();
                             		loadHtByJilian(0,1,true, yijicd, erji,zh,companyName,usertype,servletpath);
                             		//下面这两句话用于实现删除表格的隐藏
                             		/*var idValue = idStr.split("=")[1];
                             		$("td:contains("+idValue+")").parents("table").hide();*/
                         		}
                ...
                if(init){
                    ...
                    bootstrapMajorVersion:3,
                    onPageClicked: function(e,originalEvent,type,page){
                    	loadHtByJilian(1*(page-1),1,false, yijicd, erji,zh,companyName,usertype,servletpath);
                    }
                };
                    makePigination(options);
                }
