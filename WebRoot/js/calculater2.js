		...
		$(document).ready(function() {
			...
			$("#Sales-revenue,#Rent-revenue,#Land-cost,#PDE,#Rent-cost").bind('input propertychange',function(){
				...
				$("#Used-real-estate-purchase-price").bind('input propertychange',function(){
				...
				$("#Used-real-estate-evaluation-price").bind('input propertychange',function(){
				...
				$("#LVAT-prepaid-tax-rate").bind('input propertychange',function(){
					$("#Cost-base-for-calculation-of-LVAT-new-real-estate").val(((parseFloat($("#Land-cost").val())+parseFloat($("#PDE").val()))*1.3
							+parseFloat($("#Sales-revenue").val()*0.0565)).toFixed(2));
				...
				$("#Deed-tax-rate,#Deed-tax-base").bind('input propertychange',function(){
					$("#Cost-base-for-calculation-of-LVAT-GSA").val((parseFloat($("#Land-cost").val())+parseFloat($("#PDE").val()))*1.2+parseFloat($("#Business-tax-and-affiliates").val())+parseFloat($("#Deed-tax").val()));
					$("#Deed-tax").val(($("#Deed-tax-base").val()*(delPercentCharacter($("#Deed-tax-rate").val())/100)).toFixed(2));
				});
				...
				//房产原值或月租金只允许输入一个
				$("#Real-estate-monthly-rent").bind('input propertychange',function(){
				...
				$("#Real-estate-original-value").bind('input propertychange',function(){
				...
				$("#Real-estate-original-value,#Real-estate-monthly-rent").bind('input propertychange',function(){
					...
					$("#Real-estate-tax").val(Real_estate_tax.toFixed(2));
				});
